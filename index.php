...
echo '<script>window.location.href = "aws.php";</script>';
            			...
            			<form  method="post">
		            		...
		            		<div class="col-xs-12 col-sm-12 box-form">
		            			...
		            			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			            			<input id="userName" name="userName" placeholder="N&uacute;mero de Documento" type="text" class="input-login user-name" value="" maxlength="15"/>
			            			
			            		</div>
			            		<div class="col-xs-12 col-sm-12 content-check-login pdt-15">
			            				            				
			            		</div>
			            		<div class="col-xs-12 col-sm-12 pdt-15 field-password">
		            				<input id="password" name="password" placeholder="Contrase&ntilde;a" type="password" class="input-login" readonly="readonly" value="" autocomplete="off"/>
		            				
			            		</div>
			            		<div class="col-xs-12 col-sm-12 pdt-15">
			            			<div id="teclado" class="content-teclado impPass-content" style="">
